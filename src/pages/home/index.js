const onDeleteItem = async (id) => {
  ...
  try {
    ...
    await fetch(
      `https://wallet-app-api-mp-16500a81b5f4.herokuapp.com/finances/${id}`,
      {
        method: "DELETE",
        headers: {
          email: email,
...
const onLoadFinancesData = async () => {
  try {
    ...
    const result = await fetch(
      `https://wallet-app-api-mp-16500a81b5f4.herokuapp.com/finances?date=${date}`,
      {
        method: "GET",
        headers: {
          email: email,
...
const onLoadCategories = async () => {
  try {
    ...
    const response = await fetch(
      "https://wallet-app-api-mp-16500a81b5f4.herokuapp.com/categories"
    );
    const responseData = await response.json();
    const categoriesResult = responseData.rows;
...
const onCallAddFinance = async (data) => {
  try {
    ...
    const response = await fetch(
      "https://wallet-app-api-mp-16500a81b5f4.herokuapp.com/finances",
      {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
